<?php /* Smarty version 2.6.0, created on 2017-01-09 09:52:56
         compiled from billing_new/generate-bill.tpl */ ?>
<div>
    ...
    <div style="width:90%; margin-top:10px" align="left">
        <table border="0" cellspacing="2" cellpadding="3" align="left" width="100%">
            ...
            <tr>
                ...
                <td width="50%"> : &nbsp;&nbsp;&nbsp;<b><?php echo $this->_tpl_vars['sAgency']; ?>
</b></td>
                <td width="15%"><strong>Cut-Off Date</strong></td>
                <td width="55%"> : &nbsp;&nbsp;&nbsp;<?php echo $this->_tpl_vars['sCutOff']; ?>
<td>
            </tr>
            <tr>
    ...
    <div class="segContentPane" style="width:92%;">
        ...
        <div style="width:98%; padding:2%;">
            <div style="float:left;">
                Count: <?php echo $this->_tpl_vars['sCountItems']; ?>
        ...
        <div style="width:98%; height:290px; overflow-y:scroll;">
            <table id="employee-list" class="jedList" width="98%" cellspacing="0" cellpadding="0" border="1">
                ...
                <tr>
                    ...
                    <th align="center">&nbsp;&nbsp; Select <?php echo $this->_tpl_vars['selectAll']; ?>
 &nbsp;&nbsp;
                        <!-- <input onclick="getCaseNumbers();" value=<?php echo $this->_tpl_vars['sCaseNumbers']; ?>
 id="selectall" type="checkbox" name="selectall" style="valign:bottom"> -->
                    </th>
                </tr>
                </thead>
    ...
    <div style="width:89.5%; margin-top:20px">
        <table class="segList" width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
                ...
                <td id="show-sub-total" width="17% " align="right" style="background-color:#e0e0e0; color:#000000; font-family:Arial; font-size:15px; font-weight:bold"><?php echo $this->_tpl_vars['sSubTotal']; ?>
</td>
                <td></td>
            </tr>
            <tr>
                ...
                <td align="right" style="background-color:#cfcfcf; color:#006600; font-family:Arial; font-size:15px; font-weight:bold">
                    <a id="show-discount-total"><?php echo $this->_tpl_vars['sDiscount']; ?>
</a>
            ...
            <tr>
                ...
                <td id="show-net-total" align="right" style="background-color:#bcbcbc; color:#000066; font-family:Arial; font-size:15px; font-weight:bold"> <?php echo $this->_tpl_vars['sNetTotal']; ?>
 </td>
                <td></td>
            </tr>
            </tbody>
