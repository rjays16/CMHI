<?php /* Smarty version 2.6.0, created on 2017-01-06 00:40:20
...
function printPrescription(encounter_nr, prescription_id){ //added by mai 10-21-2014
...
function search() {
	...
	o['is_prescription'] = $('is_prescription').checked;
			...
			<tr>
				<td nowrap="nowrap" align="right" class="jedPanel">
					<table width="100%" border="0" cellpadding="2" cellspacing="0">
						...
						<tr>
							<td width="50" align="right"><?php echo $this->_tpl_vars['sPrescription']; ?>
</td>
							<td width="5%" nowrap="nowrap" align="right"><label for="chkarea" class="segInput">Prescription</label></td>
						</tr>
						<tr>
							<td></td>
							<td colspan="2">
