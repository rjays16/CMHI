<?php /* Smarty version 2.6.0, created on 2017-01-06 00:47:23
					...
					<td rowspan="3" class="segPanel" align="center" valign="top">
						...
						<table width="95%" border="0" cellpadding="2" cellspacing="0" style="margin-top:8px; font:normal 12px Arial" >
							...
							<tr>
								...
								<td width="1" valign="middle"><?php echo $this->_tpl_vars['sAge']; ?>
</td>
							</tr>
							<tr>
								<td align="right" valign="top"><strong>Gender</strong></td>
								<td width="1" valign="middle"><?php echo $this->_tpl_vars['sGender']; ?>
</td>
							</tr>
						</table>
					</td>
