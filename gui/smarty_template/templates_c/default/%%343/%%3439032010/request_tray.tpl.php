<?php /* Smarty version 2.6.0, created on 2017-01-06 01:10:23
...
<div id="tabs" style="width:70%;margin-top:5px">
	<ul>
		...
		<li style ="width:90px;"><a href="#tab-ip">Pharmacy</a></li>
	<!-- 	<li><a href="#tab-mg">Murang Gamot</a></li> -->
		<li style ="width:110px;"><a href="#tab-miscellaneous">Miscellanous</a></li>
		<li style ="width:120px;"><a href="#tab-pf">Professional Fee</a></li> <!-- added by mai 08/18/2014 -->
	</ul>
			...
			<table width="100%" cellpadding="0" cellspacing="0" border="0" class="dashletHeader" style="font: bold 12px Tahoma;">
				<tbody>
					<tr>
						<td width="10%" valign="top"><h1 style="white-space:nowrap">List of Requests</h1></td>
						<td align="right">
							<button class="segButton" id="openPfRequestBtn" name="openPfRequestBtn" onclick="openPfRequest();return false;" style="cursor:pointer"><img src="../../gui/img/common/default/rx.png" border="0"/>New request</button>
						</td>
					</tr>
					<tr>
						<td align="left" style="font: bold 12px Arial;"><strong>TOTAL Charge: </strong></td>
						<td><span id="pf-total-charge">0.00</span></td>
					</tr>
					<tr>
						<td align="left" style="font: bold 12px Arial;"><strong>TOTAL Cash: </strong></td>
						<td><span id="pf-total-cash">0.00</span></td>
					</tr>
				</tbody>
			</table>
		</div>
		<div id="pf_requests" align="center">
		</div>
	</div>
	<!-- end added by mai -->
