<?php /* Smarty version 2.6.0, created on 2017-01-06 10:51:27
         compiled from clinics/seg_pf_request_tray.tpl */ ?>
<?php require_once(SMARTY_DIR . 'core' . DIRECTORY_SEPARATOR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_radios', 'clinics/seg_pf_request_tray.tpl', 43, false),)), $this); ?>
<style>
	* {
...
<div style="width:700px; margin-top:10px" align="center">
 ...
 <?php echo $this->_tpl_vars['sChargeTyp']; ?>
	...
	<fieldset>
		...
		<table width="100%" cellpadding="0" cellspacing="0">
			<tr>
				<div style="float:left;"><?php echo $this->_tpl_vars['add_misc_btn']; ?>
