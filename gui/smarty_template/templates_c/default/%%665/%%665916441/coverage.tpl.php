<?php /* Smarty version 2.6.0, created on 2017-01-08 11:22:01
         compiled from insurance_co/coverage.tpl */ ?>
...
function loadItems(mode) {
	...
	$('ajaxLoader').show();
	$('save').disabled = true;
	url = "ajax/coverageItems.php?userck=<?php echo $this->_tpl_vars['sUserCK']; ?>
&nr=<?php echo $this->_tpl_vars['sEncounterNr']; ?>
&bnr=<?php echo $this->_tpl_vars['sBillNr']; ?>
&billdt=<?php echo $this->_tpl_vars['sBillDte']; ?>
&mode="+mode+"&force=<?php echo $this->_tpl_vars['sForce']; ?>
";
...
<div style="width:95%; padding:4px;">
	<div style="float:left">
		<ul id="request-tabs" class="segTab" style="padding-left:10px;">
			<li id="tabm" class="<?php echo $this->_tpl_vars['sTabMClass']; ?>
" onclick="tabClick(this)" segMode="M">
				<h2 class="segTabText">Drugs and Meds</h2>
			</li>
			<li id="tabo" class="<?php echo $this->_tpl_vars['sTabOClass']; ?>
" onclick="tabClick(this)" segMode="O">
				<h2 class="segTabText">X-Ray, Lab and Other charges</h2>
			</li>
		</ul>
	</div>
	<div style="float:right"><?php echo $this->_tpl_vars['sSaveButton']; ?>
</div>
	<br style="clear:left" />
