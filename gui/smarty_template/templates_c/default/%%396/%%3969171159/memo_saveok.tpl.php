<?php /* Smarty version 2.6.0, created on 2017-01-07 14:03:41
						...
						<tr>
							...
							<td align="left">
								<table border="0" width="100%" cellpadding="1" cellspacing="1" style="margin:4px;border:1px solid #006699">
									<tbody>
										<tr>
											<td width="10%" class="jedPanelHeader">OR No.</td>
											<td width="8%" class="jedPanelHeader">Source</td>
											<td width="8%" class="jedPanelHeader">Code</td>
											<td width="30%" class="jedPanelHeader">Particulars</td>
											<td width="10%" class="jedPanelHeader" align="center">Price</td>
											<td width="5%" class="jedPanelHeader" align="center">Qty</td>
											<td width="10%" class="jedPanelHeader" align="center">Refund</td>
											<!-- <td width="10%" class="jedPanelHeader" align="center">Total</td> -->
										</tr>
