<?php /* Smarty version 2.6.0, created on 2017-01-11 14:35:14
								...
								<table align="center" width="82%" style="font:bold 12px Arial;">
									<tbody>
										<tr>
											...
											<td style="width:400px" nowrap="nowrap"><?php echo $this->_tpl_vars['GroupFromSearch']; ?>
&nbsp;<?php echo $this->_tpl_vars['GroupFormSearchBtn'];  echo $this->_tpl_vars['AddFormBtn']; ?>
</td>
										</tr>
									</tbody>
								</table>
