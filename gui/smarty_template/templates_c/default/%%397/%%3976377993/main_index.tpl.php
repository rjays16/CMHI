<?php /* Smarty version 2.6.0, created on 2016-09-09 17:17:20
         compiled from main/main_index.tpl */ ?>
<?php require_once(SMARTY_DIR . 'core' . DIRECTORY_SEPARATOR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'default', 'main/main_index.tpl', 75, false),)), $this); ?>
<html>
<head>
<title>SegHIS - Cainglet Medical Hospital Inc.</title>
...
<link rel="stylesheet" href="js/jquery/themes/seg-ui/jquery.ui.all.css" type="text/css" />
<script type='text/javascript' src="js/jquery/jquery-1.8.2.js"></script>
<script type='text/javascript' src="js/jquery/ui/jquery-ui-1.9.1.js"></script>
<script type="text/javascript" src="js/noty/packaged/jquery.noty.packaged.min.js"></script>
<script type="text/javascript" src="js/wsnotif.js?t=<?php echo '<?='; ?>
time()<?php echo '?>'; ?>
"></script>
