<?php /* Smarty version 2.6.0, created on 2021-07-15 08:44:23
         compiled from price_adjustments/price_form.tpl */ ?>
		 ...
		 <table align="center" cellpadding="2" cellspacing="2" border="0" width="100%" style="border-collapse: collapse; border: 1px solid rgb(204, 204, 204);">
				<tbody>
						...
						<tr>
							...
							<td width="80%" nowrap="nowrap" class="segPanel"><?php echo $this->_tpl_vars['date_text'];  echo $this->_tpl_vars['date_icon']; ?>
</td>
						</tr>
						<tr>
							<td width="20%" nowrap="nowrap" align="right" class="segPanel"><b>Options</b></td>
							<td class="segPanel" style="white-space:nowrap"><?php echo $this->_tpl_vars['saveBtn'];  echo $this->_tpl_vars['cancelBtn']; ?>
</td>
						</tr>             
				</tbody>
			</table>
		...
		<table align="center" cellpadding="2" cellspacing="2" border="0" width="100%" style="border-collapse: collapse; border: 1px solid rgb(204, 204, 204);">
			<tbody>
				...
				<tr>
					...
					<td width="70%" nowrap="nowrap" class="segPanel"><?php echo $this->_tpl_vars['seldate_text'];  echo $this->_tpl_vars['seldate_icon']; ?>
</td>
				</tr>
				<tr>
					<td colspan="3" class="segPanel" align="left"><?php echo $this->_tpl_vars['searchdate_btn']; ?>
</td>
				</tr>
			</tbody>
		</table>
