<?php /* Smarty version 2.6.0, created on 2018-09-27 16:29:27
                    ...
                    <td colspan="2" rowspan="5" align="left" valign="top" class="jedPanel">
                        <table width="100%" border="0" cellpadding="2" cellspacing="0" style="font-size:11px">
                            ...
                            <tr class="jedPanel">
                                ...
                                <td width="*" align="right">&nbsp;</td>
                                <td width="8%" align="right" valign="middle"><strong>Company:</strong></td>
                                <td colspan="2" width="20%" valign="middle" align="left"><?php echo $this->_tpl_vars['sCompany']; ?>
</td>
                            </tr>
                            ...
                            <tr class="jedPanel">
                                ...
                                <td width="*" align="right"><strong>Other Insurance :</strong></td>
                                <td colspan="2" width="20%" valign="middle" align="left"><?php echo $this->_tpl_vars['sOtherInsurance']; ?>
</td>
...
<div id="coverage-dialog-hci" style="display:none">
    ...
    <table> 
        ...
        <tr>
            <td width="50%"><b>COMPANY LIMIT : </b></td>
            <td>
                <span style="text-align:left;font:bold 15px Arial"  id="company-limit-hci" name="company-limit-hci" >0.00</span>
            </td>
        </tr>
    </table>
</div>
