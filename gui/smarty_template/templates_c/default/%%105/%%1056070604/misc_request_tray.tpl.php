<?php /* Smarty version 2.6.0, created on 2017-01-06 10:59:25
         compiled from dialysis/misc_request_tray.tpl */ ?>
<?php require_once(SMARTY_DIR . 'core' . DIRECTORY_SEPARATOR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_radios', 'dialysis/misc_request_tray.tpl', 43, false),)), $this); ?>
<style>
	* {
...
<div style="width:700px; margin-top:10px" align="center">
 ...
 <?php echo $this->_tpl_vars['sChargeTyp']; ?>
                                    ...
                                    <tr>
                                    	...
                                    	<td>&nbsp;&nbsp;<?php echo $this->_tpl_vars['sCompName']; ?>
</td>
                                    </tr>
                                    <tr>
                                    	<td width="30%" align="right" nowrap="nowrap" id="cov_type"></td>
                                    	<td id="cov_amount" style="font-weight: bold;"></td>
                                    </tr>
                                    <!-- end added by mai -->
								</table>
							</td>
	...
	<fieldset>
		...
		<table width="100%" cellpadding="0" cellspacing="2">
			<tr>
				<td align="left" colspan="2" ><?php echo $this->_tpl_vars['sSearchService']; ?>
</td>
