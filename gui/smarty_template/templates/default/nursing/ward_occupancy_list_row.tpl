...
{{* This template is used by /modules/nursing/nursing_station.php to populate the ward_occupancy_list.tpl template *}}
 ...
 {{/if}}
	...
	<!--	<td style="font-size:x-small ">&nbsp;{{$sInsuranceType}}</td>-->
		...
		<td style="font-size:x-small ">&nbsp;{{$sMgh}}</td>
		<td style="font-size:x-small ">&nbsp;{{$sMembership}}</td>
		<!-- end added by mai -->
		<td>&nbsp;{{$sAdmitDataIcon}} {{$sChartFolderIcon}} {{$sNotesIcon}} {{$sTransferIcon}} {{$sMoveIcon}} {{$sDischargeIcon}} </td>
		</tr>
