			...
			<TR>
				<TD>
					...
					<TBODY class="submenu">
						...
						<TR>
							<TD width="1%">{{$sListofPatientIcon}}</TD>
                    ...
                    <TR>
                        <TD>
                            <TABLE cellSpacing=1 cellPadding=3 width=600>
                                ...
                                {{include file="common/submenu_row_spacer.tpl"}}
                                 <TR>
                                    <TD width="1%">{{$sEmployeeBillingIcon}}</TD>
                                    <TD class="submenu_item" width=35%><nobr>{{$sEmployeeBilling}}</nobr></TD>
