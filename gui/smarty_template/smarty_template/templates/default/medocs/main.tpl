			...
			<tr>
				...
				<td colspan="2">
					<table border="0" width="74%" >
						...
						<tr>
							<td {{$sClassItem}} width="31%">{{$LDCompany}}</td>
							<td bgcolor="#ffffee" class="vi_data"><b>{{$sComp}}</b></td>
						</tr>
						<tr>
							<td {{$sClassItem}} width="31%">{{$LDAdmPhysician}}</td>
							<td bgcolor="#ffffee" class="vi_data"><b>{{$sAdmPhysician}}</b></td>
						</tr>
					</table>
				</td>
				<!--
