<?php /* Smarty version 2.6.0, created on 2014-06-06 02:40:01
  ...
  &nbsp;&nbsp; <?php echo $this->_tpl_vars['sBGOInput'];  echo $this->_tpl_vars['LDO']; ?>
			...
			<?php if ($this->_tpl_vars['LDCivilStatus']): ?>
				...
				<td colspan=2 class="reg_input">
					...
					<!--added by Mai 06-06-14-->
					<?php echo $this->_tpl_vars['sCSInfantInput'];  echo $this->_tpl_vars['LDInfant']; ?>

					<!--end added by Mai 06-06-14-->
					...
					<!--added by Mai 06-06-14-->
					<?php echo $this->_tpl_vars['sCSLivedInInput'];  echo $this->_tpl_vars['LDLivedIn']; ?>
