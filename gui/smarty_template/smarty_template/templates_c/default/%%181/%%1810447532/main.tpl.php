<?php /* Smarty version 2.6.0, created on 2016-09-26 11:41:05
...
unset($_smarty_tpl_vars);
 ...
 width="31%"><?php echo $this->_tpl_vars['LDPHIC']; ?>
						...
						<tr>
							<td <?php echo $this->_tpl_vars['sClassItem']; ?>
 width="31%"><?php echo $this->_tpl_vars['LDCompany']; ?>
</td>
							<td bgcolor="#ffffee" class="vi_data"><b><?php echo $this->_tpl_vars['sComp']; ?>
</b></td>
						</tr>
						<tr>
							<td <?php echo $this->_tpl_vars['sClassItem']; ?>
 width="31%"><?php echo $this->_tpl_vars['LDAdmPhysician']; ?>
</td>
							<td bgcolor="#ffffee" class="vi_data"><b><?php echo $this->_tpl_vars['sAdmPhysician']; ?>
</b></td>
						</tr>
					</table>
				</td>
