 ...
 */
class Bill extends \CareActiveRecord
{
	/**
	...
	/**
	 * Determine if an encounter has final bill.
	 *
	 * @param $encounterNr
	 * @return bool True if there is final bill, otherwise false.
	 */
	public static function hasFinalBill($encounterNr)
	{
		...
		$criteria->addCondition('is_deleted IS NULL');
		return (Bill::model()->find($criteria) == true);
	}
