...
class EclaimsTransmittal extends Transmittal
{
    ...
    /**
     * @var string[] $xmlValidationErrors contains validation errors of
     *      Transmittal XML
     */
    ...
    /**
     * Returns the validation errors from the latest generateXml call if there
     * any.
     *
     * @return array
     */
     ...
     *
     * @return boolean - true if xml has no validation errors, 'invalid' if
     *                 there were php errors while processing
     */
     ...
     *
     * @return string[] $xmlValidationErrors | boolean - false if there were
     *                  php errors
     */
    ...
    /**
     * Prepares and arranges validation errors of a CLAIM in an array ready for
     * display
     *
     * @param string[] $xmlValidationErrors - validation errors for a specific
     *                                      claim
     *
    ...
    /**
     * Handles checking xml string for any syntax errors and saves it if no
     * errors found
     *
     * @param string $xmlString
     *
     * @return boolean - true if there was no syntax errors and saving was
     *                 successful
     */
    ...
    /**
     * Checks if xml string has any characters in between end tags(>) and start
     * tags(<)
     *
     * @param string $xmlString
     *
    ...
    /**
     * Cleans xml string of any characters in between end tags(>) and start
     * tags(<)
     *
     * @param string $xmlString
     *
     ...
     * function compactMap
     *
     * creates an array containing the parameters for accessing the mapping
     * function of the HIE web service
     *
     * @param Transmittal $transmittal
     *
     * @return array - data parameter for mapping the transmittal to HIE web
     *               service
     */
