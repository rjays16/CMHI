        ...
        foreach ($orders as $order) {
            ...
            $this->appendNode(
                ...
                array(
                    ...
                    'pGenericCode' => !empty($drug['gen_code']) ? $drug['gen_code'] : (!empty($order['generic']) && empty($order['drug_code']) ? "" : CF4Helper::getNomedsGenericCode()),
                    ...
                    'pDateAdded' => !empty($order['generic']) ? date('Y-m-d', strtotime($order['created_at'])) : date('Y-m-d', strtotime($this->encounter->encounter_date)),
