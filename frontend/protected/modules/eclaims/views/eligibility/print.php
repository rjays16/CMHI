...
define("ACCREDITATION_NUMBER","H11018135");
...
// Added by Johnmel 09-28-18
global $root_path;
$pdf->Image($root_path.'images/phic_sm.png', $pdf->GetX() + 0,  $pdf->GetY()-1, 14, 18, 'PNG');
$pdf->Image($root_path.'images/phic_mem.jpg', $pdf->GetX() + 180,  $pdf->GetY()-1, 13, 20, 'JPEG');
...
$setFont($o['styles']['value']);
$pdf->Cell($o['columnWidths']['details'][1], 0, 'Cainglet Medical Hospital, Inc.', 0, 1, 'L');
$setFont($o['styles']['label']);
...
$pdf->Cell($o['columnWidths']['details'][1], 0, ACCREDITATION_NUMBER, 0, 1, 'L');
...
$setFont($o['styles']['value']);
$pdf->Cell($o['columnWidths']['details'][1], 0, $iff($encounter->person->phicMember->FullName, '-'), 0, 1, 'L');
$setFont($o['styles']['label']);
...
$setFont($o['styles']['value']);
$pdf->Cell($o['columnWidths']['details'][1], 0, $encounter->person->FullName, 0, 1, 'L');
$setFont($o['styles']['label']);
