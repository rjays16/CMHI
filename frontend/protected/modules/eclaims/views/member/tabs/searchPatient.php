...
<?php
   ...
   <!--workaround datetimepicker  <div class="controls"> 
    ...
    ?>
    <div class="help-inline error" id="EclaimsPhicMember_birth_date_em_" style="display:none"></div><p class="help-block">e.g. 01-01-2014</p></div> -->
