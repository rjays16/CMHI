...
<script>
    // let is_applicable_for_menstrual = checkIfApplicableForMenstrual();
    // let 
    // disabled service request
    // if(is_applicable_for_menstrual == 1){
    //     $("#lmp_is_date").hide();
    //     $("#lmp_is_text").show(); 
    //     $("#date_of_lmp_is_text").val('0000-00-00');
    // }else{
    //     $("#lmp_is_date").show();
    //     $("#lmp_is_text").hide();
    // }
    // // alert(is_applicable_for_menstrual)
    // $("#is_applicable_for_menstrual").click(function(){
    ...
    $("#save-menstrual-history").on("click", function (e) {
        ...
        // const is_applicable_for_menstrual = checkIfApplicableForMenstrual();
        // console.log(date_of_lmp);
        // return false;
    ...
    function saveMenstrual() {
        // alert(date_of_lmp);
        var date_of_lmp  = null;
        // var applicable_for_menstrual  = null;
        ...
        // applicable_for_menstrual = checkIfApplicableForMenstrual();
        // if (is_applicable_for_menstrual != 1) {
        date_of_lmp = $("#date_of_lmp").val();
        // }else{
        //      date_of_lmp = $("#date_of_lmp_is_text").val();
        // }
    ...
    // function checkIfApplicableForMenstrual(){
    //     var applicable_for_menstrual = 0;
    //         if ($("#is_applicable_for_menstrual").prop("checked") == true) {
    //             applicable_for_menstrual = 1;
    //         }else if($("#is_applicable_for_menstrual").prop("checked") == false){
    //             applicable_for_menstrual = 0;
    //         }
    //         return applicable_for_menstrual;
    // }
</script>