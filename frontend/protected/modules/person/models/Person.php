...
class Person extends \CareActiveRecord
{
    ...
    public function relations()
    {
        return array(
            ...
            'encounters' => array(self::HAS_MANY, 'SegHis\modules\person\models\Encounter', 'pid', 'order' => 'encounter_date DESC',
                ...
                'select' => 'pid,encounter_nr, encounter_type, encounter_date, status'),
    ...
    public function search()
    {
        ...
        $criteria->with = array('activeEncounter' => array(
            'select' => 'encounter_nr, encounter_date, encounter_type',
            'joinType' => 'LEFT JOIN'
        ));
    ...
    public function getFullName($format = '{last_name}{suffix}, {first_name} {middle_initial}', $upperCase = true)
    {
