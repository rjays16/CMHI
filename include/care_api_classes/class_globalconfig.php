...
class GlobalConfig  extends Core{
	...
	*/
	...
	/**
	*  Gets a global config value of a config item without parameter required.
	*  The function can be switch to ON and OFF to database with values 1 and 0.
	*  @author Jeff Ponteras on 02-14-18
	*  @return int
	*/
