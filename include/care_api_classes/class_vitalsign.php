...
class SegVitalsign extends Core {
		...
		function getLatesVitalDetailsbyPid($pid,$enc_nr) { //added by mai 11-6-2014
				global $db;
		...
		*/
		function get_latest_vital_signs($pid, $encounter_nr) {
			global $db;
			$this->sql = "SELECT vitalsign_no, systole, diastole, weight, temp, resp_rate, pulse_rate, height_in, height_ft FROM $this->vital_tb WHERE
