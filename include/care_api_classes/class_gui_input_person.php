...
#echo "class_gui_input_person.php : insert mode : pinsure_obj->sql='".$pinsure_obj->sql."' <br> \n";
					...
					$HTTP_POST_VARS['street_name'] = addslashes($HTTP_POST_VARS['street_name']); //added by mai 08-29-2014
		...
		*/
		function getAge(){
			...
			try{
				...
				var age = dateNow.getFullYear() - parseInt(dobYear);
				var ageYear = (presentDate.getTime()-pastDate.getTime())/31536000000;///86400000;
				var aged = age + ageYear;
				age = Math.round(aged);
				var msg = " dob = '"+dob+"' \n dateNow = '"+dateNow+"' \n dobMonth = '"+dobMonth+"' \n"+
				" dobDay = '"+dobDay+"' \n dobYear = '"+dobYear+"' \n pastDate = '"+pastDate+"' \n"+
				" presentDate = '"+presentDate+"' \n age = '"+age+"' \n ageYear = '"+ageYear+"'";
				if ((isNaN(age)) ||(dobMAgeonth==0)||(dobDay==0)||(dobYear==0)){
					document.aufnahmeform.age.value='';
				}else{*/
					document.aufnahmeform.age.value=age;
					document.aufnahmeform.place_birth.focus();
		...
		function chkform(d) {
			...
			*/
			...
			// modified by monmon : required baranggay info
			...
			*/
			...
			// modified by monmon : require municipality
...
#echo "senior_ID = ".$senior_ID;
		...
		if (!$GLOBAL_CONFIG['person_civilstatus_hide']){
			...
			#added by Mai (06-06-2014)
			$sCSBuffer = $sCSInput.'value="INFANT" ';
			if($civil_status=="INFANT") $sCSBuffer.='checked';
			$this->smarty->assign('sCSInfantInput',$sCSBuffer.'>');
			#end added by Mai (06-06-2014)
			...
			#added by Mai (06-06-2014)
			$sCSBuffer = $sCSInput.'value="LIVED-IN" ';
			if($civil_status=="LIVED-IN") $sCSBuffer.='checked';
			$this->smarty->assign('sCSLivedInInput',$sCSBuffer.'>');
			#end added by Mai (06-06-2014)
			...
			#added by VAN 04-26-08
			#added by Mai (06-06-2014)
			$this->smarty->assign('LDInfant',$LDInfant);
			#end added by Mai (06-06-2014)
			...
			#added by Mai (06-06-2014)
			$this->smarty->assign('LDLivedIn',$LDLivedIn);
			#end added by Mai (06-06-2014)
