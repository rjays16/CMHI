...
abstract class SegReport {
    ...
    public function getLogoPath() {
        return dirname(dirname(dirname(dirname(__FILE__)))) . '/gui/img/logos/cmhi_logo.jpg';
    }

    public function getPathologistSignaturePath(){
        return dirname(dirname(dirname(dirname(__FILE__)))) . '/gui/img/logos/pathologist_juanito_signature.jpg';
    }
} 