...
# Toolbar title
 ...
 $aSubMenuIcon=array(createComIcon($root_path,'notepad.gif','0'),
										...
										createComIcon($root_path,'calendar.png','0'),
...
$aSubMenuText=array($LDPluginsTxt,
										...
										'Update Data for managing service price center manager',
...
$aSubMenuItem=array('LDPlugins' => '<a href="'.$root_path.'plugins/plugins.php'.URL_APPEND.'">'.$LDPlugins.'</a>',
										...
										'LDCostCenterPriceMgr' => '<a href="'.$root_path.'modules/system_admin/cost_center_gui_mgr/cost_center_gui_prc_pass.php?target=add_gui&'.URL_APPEND.'">Cost Center Price Manager</a>',

										// 'LDCostCenterGuiMgr' => '<a href="">Cost Center Service Price Manager</a>',
										/*'LDBilling' => '<a href="'.$root_path.'modules/ecombill/ecombill_pass.php'.URL_APPEND.'">'. $LDBilling.'</a>',
										...
										'LDHolidayMngr' => '<a href="'.$root_path.'modules/system_admin/edv-system_manage_pass.php'.URL_APPEND.'&target=holiday">'. $LDHolidayMngr.'</a>',
