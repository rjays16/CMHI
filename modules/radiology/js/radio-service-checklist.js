				...
				else if(details[i]["type"]=="D")
				{
					 ...
					 source+= "<div class=\"checklist-data\">"+
							...
							"<span id='name"+details[i]["service_code"]+"' class='checklist-name'>"+details[i]["service_name"]+"</span>"+
								//aded julius
							"<input id='incprCePHIC"+details[i]["service_code"]+"' type='hidden' value='"+details[i]["priceincreaseperoomPHIC"]+"'/>"+
							"<input id='incprCeNONPHIC"+details[i]["service_code"]+"' type='hidden' value='"+details[i]["priceincreaseperoomNONPHIC"]+"'/>"+
							"<input id='hasroom"+details[i]["service_code"]+"' type='hidden' value='"+details[i]["Ifhasroom"]+"'/>"+
							//end
