...
function jsListRows(sub_dept_nr,No,refNo,rid,name,sex,dateRequest,priority, repeat,paid, or_no, enctype,location,pid, encounter_nr,age,bdate, attending_dr, services){
		...
		if(refNo){
			...
			srcRows = '<tr>'+
						  ...
						  '<td align="left">'+gender+'&nbsp;&nbsp;'+name+'</td>'+
							...
							'<td align="left" style="font-size:11px">'+services+'</td>'+
							'<td align="left" style="font-size:11px">'+attending_dr+'</td>'+
