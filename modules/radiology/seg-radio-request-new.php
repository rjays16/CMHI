        ...
        case 'update':
                ...
                #-----------------------------------------
                    ...
                    if($radio_obj->updateRadioRefNoInfoFromArray($_POST)){
                        ...
                        $curl_obj->inpatientRadioItem($_POST['refno']);
                        $smarty->assign('sysInfoMessage',"Radiological Request Service successfully updated.");
...
<?php
    ...
    $smarty->assign('sOrderAddress','<textarea class="segInput" id="orderaddress" name="orderaddress" cols="37" rows="2" style="font:bold 12px Arial" >'.$orderaddress.'</textarea>');#edited by daryl
...
if ($ifwalkin == 1){
    ...
    if($ptype == 'doctor') 
        $smarty->assign('sSearchService','<input class="segInput" placeholder="Search Radiology Services" id="searchservice" name="searchservice" type="text" size="30" style="font:bold 15px Arial;"/>');
...
?>
    ...
    <script type="text/javascript" language="javascript">
        ...
        if (refno){
            ...
            xajax_populateRequestListByRefNo(refno, batchnr, fromSS, discount, discountid, walkin_pat,enc);
...
$smarty->assign('sMainBlockIncludeFile','radiology/radio-request-new'.(( $ptype == 'doctor' ) ? '2' : '').'.tpl');
