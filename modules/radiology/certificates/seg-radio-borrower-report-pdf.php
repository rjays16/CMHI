...
// Hospital Logo
$pdf->Image($root_path.'gui/img/logos/cmhi_logo.jpg',20,10,25,30);
...
$pdf->Cell(0,4,'CAINGLET MEDICAL HOSPITAL INC',$border_0, 1, 'C');

//Hospital Address
$pdf->Ln(1);
$pdf->setFont($fontStyle,"", $fontSizeInput);
$pdf->Cell(0,4,'Panabo City',$border_0, 1, 'C');
