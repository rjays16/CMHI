...
function gui_addIcdCodeRow(encounter,code,desc,target,create_id,type, doc, dept, code2) {
			...
			if(code2 != '0'){
				newRowSrc = '<tr class="wardlistrow'+(lastRowNo%2)+'" style="font-weight:'+fontweight+'" id="icdCodeRow'+lastRowNo+'"  >'+
						'<td>'+
							...
							'<span id="codemain'+lastRowNo+'">' +
								'<a onClick="editAltCode(\''+lastRowNo+'\')" style="cursor:pointer" >'+code2+'</a>'+
							'</span>' +
						'</td>'+
						'<td>';
			}
				...
				newRowSrc = '<tr class="wardlistrow'+(lastRowNo%2)+'" style="font-weight:'+fontweight+'" id="icdCodeRow'+lastRowNo+'"  >'+
						'<td>'+
							...
							'</span>'+
							'<span id="codemain'+lastRowNo+'">' +
								'<a onClick="editAltCode(\''+lastRowNo+'\')" style="cursor:pointer" >'+code+'</a>'+
							'</span>' +
						'</td>'+
						'<td>';
			}//ended by ken 4/10/2014
