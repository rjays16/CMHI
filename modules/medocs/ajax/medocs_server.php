				...
				if($dCount>0){
					...
					while($result=$cdDiagnosis->FetchRow()){
						if($result['status']!='deleted'){
							...
							$objResponse->addScriptCall("gui_addIcdCodeRow",$result['encounter_nr'],$result['code'],$result['diagnosis'],$target,$result['create_id'],$type, $doctor, $dept,$result['code_alternative']);
						}
					}// end while statement
				}
			//}else{
