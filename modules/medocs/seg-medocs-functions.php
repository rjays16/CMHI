...
<script type="text/javascript">
	...
	function DischargePatientSearchFxn(){
		urlholder="<?=$root_path?>modules/registration_admission/list_of_discharged_patients.php?sid=$sid&lang=$lang&target=seg_billing_list_patients&user_origin=medocs";
		window.location.href=urlholder;
	}
	//end added by mai
</script>
...
#line 55 was added by VAN 09-20-08 , add a link for new request for all cost centers
 $aSubMenuIcon=array(
  ...
  createComIcon($root_path,'group_delete.png','0'), //added by mai 11132014
...
$aSubMenuText=array(
  ...
  "List of discharged patients.", //added by mai 11132014
...
$aSubMenuItem=array(
  ...
  'LDListOfDischargedPatient' => '<a href="javascript:DischargePatientSearchFxn();">List of Discharged Patients</a>', //added by mai 09032014
