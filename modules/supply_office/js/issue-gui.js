            ...
            if (details) {
               ...
               // rowno = i+1;
                ...
                src+=
                    ...
                    '<td align="right"><span style="color:#660000" id="avg_cost'+ id+'" name="avg_cost[]"></span>'+formatNumber(avg,2)+'</td>'+
                    '<td align="right"><span style="color:#660000" id="total_cost'+ id+'" name="total_cost[]"></span>'+formatNumber(totalCost,2)+'</td></tr>';
