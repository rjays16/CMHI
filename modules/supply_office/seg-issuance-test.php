...
//        $db->failTrans();
        ...
        if ($saveok) {
            ...
            foreach ($_REQUEST['items'] as $i=>$v){            
                ...
                $items_table[] = "<tr><td>".$_REQUEST['items'][$i]."</td><td>".$_REQUEST['name'][$i]."</td><td>". $_REQUEST['request_pending'][$i] ."</td><td>". $_REQUEST['unitdesc'][$i] ."</td><td>". $_REQUEST['serial'][$i] ."</td><td>". $_REQUEST['expdate'][$i] ."</td></tr>";                    
            }
