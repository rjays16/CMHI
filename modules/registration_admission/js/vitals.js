				...
				if (dBody) {
						...
						if (details) {
								...
								var trayItems = 0,
										...
										hieghtin = details.hieghtin,
										hieghtft = details.hieghtft,
										pid = details.pid,
								 ...
								 if (vitalno) {
												if ($('rowvitalno'+vitalno)) {
														...
														$('rowheightin'+vitalno).value         = details.hieghtin
														$('rowheightft'+vitalno).value         = details.hieghtft
								...
								src =
										...
										'<input type="hidden" name="hieghtin[]" id="rowheightin'+vitalno+'" value="'+details.hieghtin+'" />'+
										'<input type="hidden" name="hieghtft[]" id="rowheightft'+vitalno+'" value="'+details.hieghtft+'" />';
								...
								src+=
										...
										'<td align="center"><span style="color:#660000">'+details.hieghtin+'</span></td>'+
										'<td align="center"><span style="color:#660000">'+details.hieghtft+'</span></td>'+
										'<td>'+
