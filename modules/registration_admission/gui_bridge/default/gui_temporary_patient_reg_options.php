...
<?php
	if ($enc_Info['is_DOA']==1){
		echo "<a href=\"".$root_path."modules/registration_admission/certificates/cert_DOA_pdf.php".URL_APPEND."&pid=$pid&encounter_nr=$encounter_nr\" target=_blank>Dead On Arrival Certificate</a>";
	}else{
...
<?php
	...
	if (($allow_medocs_user)&&(($encounter_type_a==2) || ($encounter_type_a==1) || ($encounter_type_a==3) || ($encounter_type_a==4)) && ($encounter_status<>'cancelled')){
		#if ($encounter_nr){
?>
		<TR>
			<td align=center><img <?php echo createComIcon($root_path,'icon_acro.gif','0'); ?>></td>
...
<!-- added by mai 09-15-2014	 -->			
		<TR>
				<td align=center><img <?php echo createComIcon($root_path,'documents.gif','0'); ?>></td>
				<TD vAlign=top >
						<FONT face="Verdana,Helvetica,Arial" size=2>
<?php
echo "<a href=\"javascript:void(0);\" onclick=\"CompreDisc();\" onmouseout=\"nd();\">Comprehensive Report/Discharge Information</a>";
?>
						</FONT>
				</TD>
		</TR>
