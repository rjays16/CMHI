...
if ($row = $objInfo->getAllHospitalInfo()) {
		...
		$row['hosp_name']    = "Cainglet Medical Hosptal, Inc.";
...
$pdf->Ln(4);
$pdf->SetFont($fontStyle,"B", $fontSizeHeader2);
$pdf->Cell(0,25 , 'CERTIFICATE OF CONFINEMENT', $border2,1,'C');
#$pdf->Image($root_path.'gui/img/logos/dmhi_logo.jpg',20,10,25,30); commented by art 01/18/2014
//added by art 01/18/2014
$pdf->Image('../image/cmhi_logo.jpg',18,9,24,22);
...
if($confCertInfo["modify_dt"]!=NULL){
	...
	$date_created = @formatDate2Local(date('M-D-Y'),$date_format);
...
$pdf->Ln(10);
$pdf->SetFont($fontStyle,"", $fontSizeText);
$pdf->Cell(5,3, 'TO WHOM IT MAY CONCERN:', $border2,1,'L');
...
//Hospital Address
$pdf->Ln(2);
$pdf->setFont($fontStyle,"B", $fontSizeInput);
$pdf->Cell(0,4,$row['hosp_addr1'],$border2, 1, 'C');
