...
<?php }
		...
		{
				?><a><img id="select-enc" onmouseout="nd();" onclick="return overlib( OLiframeContent('../../modules/registration_admission/seg-admission-history.php?encounter_nr=<?= $HTTP_SESSION_VARS['sess_en']?>', 800, 400, 'fSelEnc', 1, 'auto'), WIDTH,800, TEXTPADDING,0, BORDER,0, STICKY, SCROLL, CLOSECLICK, MODAL, CLOSETEXT, '<img src=../..//images/close.gif border=0 >', CAPTIONPADDING,4, CAPTION,'Patient Admission History', MIDX,0, MIDY,0, STATUS,'Patient Admission History');" style="cursor: pointer;" title="Show details"  name="select-enc" type="image" <?php echo createLDImgSrc($root_path,'consultation_history.gif','0','top') ?> /></a>
				<?php
		}
