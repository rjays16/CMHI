...
if($_REQUEST['chktrans']){
	$filters['TRANSMITTAL_NO'] = $_REQUEST['trans_no'];
}
...
-->
												...
												<tr>
													<td width="5%" align="right"><input type="checkbox" id="chktrans" name="chktrans" <?= ($_REQUEST['chktrans'] ? 'checked' : '') ?>/></td>
													<td width="15%" nowrap="nowrap" align="left">Transmittal No.</td>
													<td><input class="jedInput" name="trans_no" id="trans_no" type="text" size="30" value="<?= $_REQUEST['trans_no'] ?>"/></td>
												</tr>
												<tr>
