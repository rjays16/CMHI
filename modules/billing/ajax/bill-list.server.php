...
require_once($root_path.'include/care_api_classes/class_encounter.php'); //added by mai 09-30-2014
...
function lockCharging($encounter_nr, $islock){
	...
	if($encObj->lockCharging($encounter_nr, $islock)){
		$objResponse->addScriptCall("refreshPage");
	}else{
		$objResponse->addAlert("Unable to update patient charging.");
	}
