...
//added by EJ 09/09/2014
$smarty->assign('sPromissoryNoteIcon','<img ' . createComIcon($root_path,'articles.gif','0') . ' align="absmiddle">');
$smarty->assign('LDPromissoryNote',"<a href=\"bill-pass.php?target=seg_promissory_note\">Promissory Note</a>");
//end by EJ
...
$smarty->assign('sListofPatientIcon','<img ' . createComIcon($root_path,'prescription.gif','0') . ' align="absmiddle">');
...
$smarty->assign('sCompanyBilling',"<a href=\"bill-pass.php?sid=$sid&lang=$lang&target=company_billing&user_origin=lab&c_type=company\">Company billing</a>");
$smarty->assign('sEmployeeBillingIcon','<img ' . createComIcon($root_path,'pers_tree.gif','0') . ' align="absmiddle">');
$smarty->assign('sEmployeeBilling',"<a href=\"bill-pass.php?sid=$sid&lang=$lang&target=company_billing&user_origin=lab&c_type=person\">Employee billing</a>");
$smarty->assign('sCompanyManagerIcon','<img ' . createComIcon($root_path,'settings_tree.gif','0') . ' align="absmiddle">');
$smarty->assign('sCompanyManager',"<a href=\"bill-pass.php?sid=$sid&lang=$lang&target=company_manager&user_origin=lab\">Company/Employee Manager</a>");
//end Jarel
