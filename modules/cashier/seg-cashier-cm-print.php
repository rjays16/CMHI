...
#	$pdf->Cell(0,$rowH,$info['memo_address'],$borderNo,$newLineYes,'L');
	...
	$pdf->Cell($colW[6],$rowH,'Refund',$borderYes,$newLineYes,'C',$fillYes);
	...
	foreach ($details as $i=>$row) {
		...
		$pdf->Cell($colW[3],$rowH,$row['service_name'],$borderYes,$newLineNo,'C',$fillNo);
		...
		$pdf->Cell($colW[6],$rowH,number_format($row['refund_price'],2),$borderYes,$newLineYes,'R',$fillNo);
		$total_refund += $total;
	}
