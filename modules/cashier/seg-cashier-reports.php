...
// $smarty->assign('pbBack',$returnfile);
 ...
 $smarty->assign('sOnLoadJs','onLoad="selOnChange();"');
		...
		<tbody>
			...
			<tr>
				<td nowrap="nowrap" align="right" class="segPanel">
					...
					<table name="selOptions" width="100%" border="0" cellpadding="2" cellspacing="0" segOption="dailycollectionperacct" style="display:none;">
						<tr>
...
?>
                        ...
                        <tr>
                            <td align="right">
                                <td nowrap="nowrap">
                                <input type="radio" id="dailycollectionreportspdf" name="param" class="segInput" value="pdf" paramName="pdf" segOption="dailycollectionfull">PDF
                                &nbsp;
                                <input type="radio" id="dailycollectionreportsexcel" name="param" class="segInput" value="excel" paramName="excel" segOption="dailycollectionfull">EXCEL
                            </td>
                            </td>
                        </tr>
					</table>
