...
if (isset($_POST["submitted"]) && !$_REQUEST['viewonly']) {
	...
	if ($saveok) {
		...
		$bulk = array();
		foreach ($_POST["items"] as $i=>$v) {
			$bulk[] = array($_POST["orno"][$i],$_POST["src"][$i],$_POST["ref"][$i],$_POST["items"][$i],$_POST["name"][$i],$_POST["desc"][$i],$_POST["refund"][$i],$_POST["price"][$i],$_POST["refund_total"][$i]);
		}
...
if (isset($_POST["submitted"])) {
	if ($saveok) {
		...
		foreach ($_POST["items"] as $i=>$v) {
			...
			$items .= '
	<tr>
		<td class="jedPanel3" align="left">'.$_POST['orno'][$i].'</td>
		<td class="jedPanel3" align="left">'.$_POST['src'][$i].'</td>
		<td class="jedPanel3" align="left">'.$v.'</td>
		<td class="jedPanel3" align="left">'.$_POST['name'][$i].'</td>
		<td class="jedPanel3" align="center">'.number_format((float)$_POST['price'][$i],2).'</td>
		<td class="jedPanel3" align="center">'.$_POST['refund'][$i].'</td>
		<td class="jedPanel3" align="center">'.number_format((float)$_POST['refund_total'][$i],2).'</td>
	</tr>
';
		}
