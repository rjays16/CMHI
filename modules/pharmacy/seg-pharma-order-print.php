<?php
	...
	$pdf->Image($root_path.'gui/img/logos/cmhi_logo.jpg',40,5,15);
  ...
  //$pdf->Cell(0,4,'Republic of the Philippines',$borderNo,$newLineYes,'C');
	...
	$gg=$pdf->gety();
	$pdf->sety($gg-13);
	$pdf->Cell(198,4,'CAINGLET MEDICAL HOSPITAL, INC.',$borderNo,$newLineYes,'C');

	$pdf->SetFont($font,"B","8");
	$pdf->Cell(17,4);
  $pdf->Cell(163,4,'Panabo City',$borderNo,$newLineYes,'C');
  //$pdf->Ln(1);
