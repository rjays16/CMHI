...
//Confinement Type
$smarty->assign('sConfineType','<input class="segInput" id="confine_type" name="confine_type" type="text" size="16"  value="" style="font:bold 12px Arial" readOnly>');
...
//Amount
$smarty->assign('sAmount','<input class="segInput" id="amount" name="amount" type="text" size="16"  value="" style="font:bold 12px Arial">');
