...
if (!empty($encounter_nr)) {
    ...
    #modified by monmon : if no member type fetched, use membertype from info
    $mtype = ($encounter->getMemberType($encounter_nr)) ?: @$info['member_type'];
} else {
...
<div class="modal-content">
    ...
    <form id="member-form" action="#">
        ...
        <select id="member-sex" name="pMemberSex" class="segInput">
