...
$countItems=0;
$smarty->assign('sCountItems', '<input type="text" disabled size="1" class="segInput" id="count_items" value="'.$countItems.'">');
...
if($c_type == 'company'){
    $smarty->assign('amountHeader','Total amount for Company');
    $smarty->assign('columnHeader','Patient Name');
    $smarty->assign('cType','Company');
}else{
    $smarty->assign('amountHeader','Total amount for Employee');
    $smarty->assign('columnHeader','Employee Name');
    $smarty->assign('cType','Employee');
}
...
$smarty->assign('selectAll', '<input type="checkbox" id="select_all" name="select_all" onclick="selectAll(this.checked);">');
