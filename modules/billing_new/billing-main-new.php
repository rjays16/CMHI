...
if (!isset($_GET['nr']) || ($_GET['nr'] == '')) {
		...
		if ($pid) {
			...
			if($_POST["admission_date"])
					...
					$enc_date =  date("M d, Y h:i A", strtotime($encobj->EncounterDate($encounter_nr)));
			}
...
//Company
$smarty->assign('sCompany','<input class="segInput" id="comp_name" name="comp_name" type="text" size="16"  value="" style="font:bold 12px Arial" readOnly>');

//Other Insurance
$smarty->assign('sOtherInsurance','<input class="segInput" id="insurance_name" name="insurance_name" type="text" size="16"  value="" style="font:bold 12px Arial" readOnly>');
