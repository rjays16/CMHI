...
function getApplicableInsurance($pid) {

	$objResponse = new xajaxResponse();
	$insurance = new Billing();
 	
 	$list = $insurance->getInsuranceInfo($pid);
...
function getInsuranceInfo($pid, $id) {
	global $db;
	$objResponse = new xajaxResponse();
	$insurance = new Billing();

	$info = $insurance->getInsuranceInfo($pid, $id);
...
function deleteInsurance($pid, $id) {
	...
	$result = $insurance->deleteInsurance($pid, $id);
	if ($result) 
		$objResponse->addScriptCall("js_getApplicableInsurance");
	else
		$objResponse->alert("ERROR: ".$db->ErrorMsg());
