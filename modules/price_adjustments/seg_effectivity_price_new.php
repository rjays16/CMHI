...
$can_edit = $acl->checkPermissionRaw(array('_a_1_priceadjust_manager'));
...
$smarty->assign('search_service', '<input type="text" class="segInput" id="service_name" size="50" onkeyup="if(this.value.length>=3) startAJAXSearch(this.id,0,\''.$disabler.'\')" style="background-color: rgb(226, 234, 243); border-width: thin; font: bold 13px Arial;" readonly=""/>');
$id="service_name";
