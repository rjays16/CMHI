...
function viewLabResult(refno,code,pid,group_id,form_id){     
	...
	if(form_id!=0){
		window.open("../../modules/repgen/pdf_lab_results_specialforms.php?pid="+pid+"&refno="+refno+"&group_id="+group_id+"&service_code="+code,"viewPatientResult","left=150, top=100, width=620,height=440,menubar=no,resizable=yes,scrollbars=yes");
	}else{
...
function addResultList(listID, service_name, service, req_date, group_id, refno, form_id) {
	...
	if (list) {
		...
		if (service) {
			...
			icon_result = '<a href="javascript:void(0);" onClick=viewLabResult(\''+refno+'\',\''+service+'\',\''+pid+'\',\''+group_id+'\',\''+form_id+'\');><img src="../../images/cashier_view_red.gif" border="0" title="Click for the Result"></a>';
