...
<script type="text/javascript">
	...
	//added by mai 11/1/2014
	function PatientQueueFxn(){
		urlholder = urlholder="<?=$root_path?>modules/registration_admission/list_patient_queue.php?sid=$sid&lang=$lang&target=seg_billing_list_patients&user_origin=opd";
		window.location.href=urlholder;
	}
	//end added by mai
</script>
...
#line 55 was added by VAN 09-20-08 , add a link for new request for all cost centers
 $aSubMenuIcon=array(
  ...
  createComIcon($root_path,'group.png','0'),
...
$aSubMenuText=array(
  ...
  "List of patients", //added by mai 11012014
...
$aSubMenuItem=array(
  ...
  'LDPatientQueue' => '<a href="javascript:PatientQueueFxn();">Patient Queue</a>', //added by mai 11012014
