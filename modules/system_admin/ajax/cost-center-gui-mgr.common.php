<?php
	...
	$xajax->register(XAJAX_FUNCTION, "cosCenter");
	$xajax->register(XAJAX_FUNCTION, "searchcostcenter");
	$xajax->register(XAJAX_FUNCTION, "updatecostcenter");
	$xajax->register(XAJAX_FUNCTION, "gethistofcenter");
?>
