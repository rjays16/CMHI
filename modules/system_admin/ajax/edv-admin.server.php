<?php
	...
	function deleteHoliday($id){
		...
		$holiday_obj->details = array('id'=>$id);

		if($holiday_obj->removeHoliday()){
			$objResponse->addScriptCall("refreshPage");
		}else{
			$objResponse->addAlert("Unable to remove holiday");
		}
	...
	require($root_path.'include/care_api_classes/class_holiday.php');
