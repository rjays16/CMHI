<?php
    ...
    $sql_view_adm = "INSERT INTO seg_report_admission_dept(nr, dept_name, admission)
    ...
    $sql_view_disc = "INSERT INTO seg_report_discharges_dept(nr, dept_name, discharges, discharges_alive,
                                                                discharges_died, discharges_noresult,total_no_days)
                        SELECT d.nr, d.name_formal AS dept_name,
