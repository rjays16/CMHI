...
$comp_obj = new Company(); //added by mai 07-19-2014
...
/*end added by mai*/
 ...
 $no_items = 0;
	...
	$_POST['refno'] = $refno; //added by mai
	...
	if($saveok_cnt==0 && $no_items==1 && !$saveok1) //updated by mai 07-21-2014
	{
	...
	else if($saveok_cnt>0 && $saveok1) //updated by mai 07-21-2014
	{
      ...
      $printfile = $root_path.'modules/dialysis/seg-misc-request-print.php'. URL_APPEND."&target=print&userck=$userck".'&ref='.$_POST['refno'];
...
//Added By Jarel 10/09/2014
$smarty->assign('sSearchService','<input class="segInput" placeholder="Search Miscellaneous Services" id="searchservice" name="searchservice" type="text" size="30" style="font:bold 15px Arial;"/>');
...
if($encounter_nr){
    ...
    $trans_amount = $comp_obj->hasChargeToCompany($encounter_nr, 'MSC', $refno);
    $smarty->assign('sCompName', $comp_name);
}

$smarty->assign('sChargeTyp','
<select id="grant_type"  name="grant_type" onchange="changeTransaction(0);">
